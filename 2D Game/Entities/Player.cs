	...
	class Player : Entity {
		...
		private void HandleItemUsage() {
			if (!PlayerInventory.Instance.InventoryOpen) {
				...
				GameLogic.AdditionalDebugText = tile.ToString () + Environment.NewLine +
				tile.tileattribs.ToString () + "Position: " + SelectedTilePos.x + ", " + SelectedTilePos.y + Environment.NewLine +
				"Lighting: [R " + lighting.x + " G " + lighting.y + " B " + lighting.z + " ]";
