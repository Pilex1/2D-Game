...
namespace Game.Terrains {
	...
	class Tile {
		...
		public static readonly Tile Invalid = new Tile (TileID.Invalid, new TileAttribs (() => RawItem.None) {
			solid = true,
			movable = false
		});
		public static readonly Tile Air = new Tile (TileID.Air, new TileAttribs (() => RawItem.None) {
			solid = false,
			movable = false,
			transparent = true
		});
		...
		public static readonly Tile Tnt = new Tile (TileID.Tnt, new ExplosionAttribs (() => RawItem.Tnt) {
			radius = 10,
			error = 2
		});
		public static readonly Tile Nuke = new Tile (TileID.Nuke, new ExplosionAttribs (() => RawItem.Nuke) {
			radius = 50,
			error = 2
		});
		...
		public static readonly Tile Light = new Tile (TileID.Light, new LightAttribs (8, new ColourRGB (255, 0, 0), 1, () => RawItem.Light));
